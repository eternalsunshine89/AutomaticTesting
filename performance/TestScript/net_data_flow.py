...
from AutoTest.performancetest.comman import atx_init, pkg_name, QQ_key, QQ_user, U2


# 数据获取与处理
class GetData(object):
    def get_data(self, pkg):
        adb = ADB()
...
class TestCase(GetData):
    ...
    def test3(self):
        u2 = U2()
        # 添加并登录本机QQ
        start_flow1 = self.diff('com.tencent.mobileqq')
...
def run_network(state, t=300):
    ...
    mail_content = """
                    ...
                    <p>场景三：对比本机和双开QQ登录并置于后台5分钟的流量消耗(双开-本机)</p>
                    <p></p>
                    <p></p>
                    <div id="content">
